...
namespace wspp {
namespace web {
std::string FormFieldValidator::interpolateMessage(const std::string &msg_template,
        const std::string &value, const FormField &field, const util::Dictionary &params) {
    string res, param;
    bool in_param = false;
